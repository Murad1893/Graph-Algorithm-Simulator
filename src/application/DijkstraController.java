...
public class DijkstraController implements Initializable {
   ...
   public void close()
    ...
    public void run ()
    {
        ...
        if(r1.isSelected())
        {
            b = new DijkstraShortestPath(graph.getAdjacencylist(), graph.getNode_num(),graph, false);
            text.setText(b.dijkstra_GetMinDistances(Integer.parseInt(last)));
            ans.setText(b.ans);
        }

        if(r2.isSelected())
        {
            b = new DijkstraShortestPath(graph1.getAdjacencylist(), graph1.getNode_num(),graph1, true);
            text.setText(b.dijkstra_GetMinDistances(Integer.parseInt(last)));
            ans.setText(b.ans);
        }
